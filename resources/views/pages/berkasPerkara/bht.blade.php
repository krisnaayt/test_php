            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form form-vertical" id="setBhtForm">
                                @csrf
                                                    ...
                                                    <tbody id="perkaraTbody">
                                                        @foreach ($berkas->perkara as $perkara)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="controls">
                                                                        <input type="text" class="form-control bootstrapDatepicker tglBht" name="tglBht[{{ $perkara->id_perkara }}]" placeholder="Tgl BHT" value="{{ $perkara->tgl_bht }}">
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        @endforeach
...
@section('page-script')
    <script src="{{ asset('js/pages/berkasPerkara/bht.js') }}"></script>
@endsection
