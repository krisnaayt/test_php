...
<section>
  <div class="row d-flex vh-100 align-items-center justify-content-center">
    <div class="col-xl-6 col-md-8 col-sm-10 col-12 px-md-0 px-2">
        <div class="card w-100 mb-0">
            <div class="card-header justify-content-center pb-0">
                {{-- <div class="card-title"> --}}
                    <div class="col-sm">
                        <button class="btn btn-success w-100 backToList">Back</button>
                    </div>

                    <div class="col-sm">
                        <button class="btn btn-primary w-100" id="exportSuratBtn">Export</button>
                    </div>
                {{-- </div> --}}
            </div>
            <hr>
                    ...
                    <div class="row">
                        <div id="exportContent">
                            <div class="col-12">
                                <table>
                                    <tbody style="font-family: Arial">
                                        <tr style="height: 10px">
                                            ...
                                            <td><b>PENGADILAN AGAMA BATULICIN KELAS II</b></td>
                                        </tr>
                                        <tr >
                                ...
                                <br>
                                <table class="table table-borderless" id="dataSuratPanjarTable">
                                    <tbody style="font-family: Arial">
