            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form form-vertical" id="editPerkaraForm">
                                @csrf
                                <input type="hidden" id="idSmsAkta" name="idSmsAkta" value="{{ encrypt($akta->id_sms_akta) }}">
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="controls">
                                                                <input type="number" id="noHpPemohon" class="form-control" name="noHpPemohon" placeholder="" value="{{ $akta->no_hp_pemohon }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="controls">
                                                                <input type="number" id="noHpTermohon" class="form-control" name="noHpTermohon"  placeholder="" value="{{ $akta->no_hp_termohon }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
...
@section('page-script')
    <script src="{{ asset('js/pages/smsNotifAkta/edit.js') }}"></script>
@endsection
